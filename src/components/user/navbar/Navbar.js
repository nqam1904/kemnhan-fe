  ...
  render() {
    return (
      <div className="nav" id="nav">
        ...
        <div className="links">
          <Link smooth to="#nav">Trang chủ</Link>
          <Link smooth to="#product">Sản phẩm</Link>
          <Link smooth to="#about">Giới thiệu</Link>
          <Link smooth to="#footer">Liên hệ</Link>
          <Link to="/gio-hang">
        ...
        <nav className="menu__item__mobile">
          ...
          <Link smooth to="#" className="titile__link_mobile">
            <p className="titile__item">Trang chủ</p>
          </Link>
          <Link smooth to="#product" className="titile__link_mobile">
            <p className="titile__item">Sản phẩm</p>
          </Link>
          <Link smooth to="#about" className="titile__link_mobile">
            <p className="titile__item">Giới thiệu</p>
          </Link>
          <Link smooth to="#footer" className="titile__link_mobile">
