        ...
        return (
            <div className="wrapper">
                ...
                >
                    ...
                    <Modal.Body>Kính chúc quý khách 1 năm mới an khang thịnh vượng, tấn tài tấn lộc, vạn sự như ý</Modal.Body>
                    <Modal.Footer>
                        <Button
                            variant="primary"
                            onClick={() => {
                ...
                <Switch>
                    {routes.map((prop, key) => {
                        if (prop.layout === `/trang-chu` || prop.layout === `/success`) {
                            return (
                                <Route
                                    component={(props) => <prop.component {...props} someThingProps="this is some props" />}
                                    key={key}
                                    path={prop.path}
                                />
                            );
