...
`])),function(e){return e.wrapCell?"normal":"nowrap"},function(e){return e.allowOverflow?"visible":"hidden"}),No=R(yo)(Tr||(Tr=v([`
	font-size: `,`;
	font-weight: 400;
	`,`;
	`,`;
...
`],[`
	`,`;
`])),function(e){return e.button&&"text-align: center"}),ti=R.div(Nr||(Nr=v([`
	display: inline-flex;
	align-items: center;
	height: 100%;
	line-height: 1;
